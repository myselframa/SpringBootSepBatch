  ...
  package com.codeconnect.configuration;
  ...
  @Value("${fmc.openapi.dev-url}") private String devUrl;
  
  @Value("${fmc.openapi.prod-url}") private String prodUrl;
  
  @Bean 
  public OpenAPI myOpenAPI() { Server devServer = new Server();
  ...
  Contact contact = new Contact(); contact.setEmail("fmc@gmail.com");
  contact.setName("fmc"); contact.setUrl("https://www.fmc.com");
  ...
  termsOfService("https://www.fmc.com/terms") .license(mitLicense);
